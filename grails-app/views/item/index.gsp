		...
		<div id="list-item" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="lastUpdate" title="${message(code: 'item.lastUpdate.label', default: 'Last Update')}" />
					
						<g:sortableColumn property="lastUpdatedBy" title="${message(code: 'item.lastUpdatedBy.label', default: 'Last Updated By')}" />
				...
				<g:each in="${itemInstanceList}" status="i" var="itemInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${itemInstance.lastUpdate}" /></td>
					
						<td>${fieldValue(bean: itemInstance, field: "lastUpdatedBy")}</td>
