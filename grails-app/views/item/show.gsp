	...
	<body>
		...
		<div id="show-item" class="content scaffold-show" role="main">
			...
			<ol class="property-list item">
				...
				<g:if test="${itemInstance?.lastUpdate}">
				<li class="fieldcontain">
					<span id="lastUpdate-label" class="property-label"><g:message code="item.lastUpdate.label" default="Last Update" /></span>
					
						<span class="property-value" aria-labelledby="lastUpdate-label"><g:formatDate date="${itemInstance?.lastUpdate}" /></span>
				...
				<li class="fieldcontain">
					<span id="lastUpdatedBy-label" class="property-label"><g:message code="item.lastUpdatedBy.label" default="Last Updated By" /></span>
						...
						<span class="property-value" aria-labelledby="lastUpdatedBy-label"><g:fieldValue bean="${itemInstance}" field="lastUpdatedBy"/></span>
